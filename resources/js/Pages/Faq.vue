<template>
    <MainLayouts>
        <section class="bg-white py-14 px-6 md:px-16 lg:px-24">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <!-- FAQ List -->
                <div
                    class="space-y-8 max-w-4xl mx-auto bg-[#15224F] p-12 rounded-2xl"
                >
                    <div class="border rounded-md text-left bg-white">
                        <div
